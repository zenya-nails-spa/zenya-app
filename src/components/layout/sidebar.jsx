...
const Sidebar = ({ active, onNavigate, items = [], collapsed = false, mobileOpen = false, onCloseMobile }) => (
  <>
    <aside
    ...
    >
        ...
        <div style={{ padding: '0 12px 12px' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <Zap size={16} strokeWidth={1.8} style={{ color: 'var(--lavender-700)' }} />
              <span
                style={{
                  fontFamily: 'var(--font-sans)',
            ...
            >
              Desbloquea reportes avanzados y más funciones.
            </div>
            <button
              style={{
      ...
      >
        <Avatar name="Valentina López" size="sm" tone="rose" />
        {!collapsed && (
          <>
