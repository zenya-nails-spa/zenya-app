...
export const api = {
  ...
  clientComplaints: (params) => get('/client-complaints', params),
  clientComplaintsSummary: (params) => get('/client-complaints/summary', params),
  clientComplaintsFlaggedIds: () => get('/client-complaints/flagged-client-ids'),
  createClientComplaint: (body) => post('/client-complaints', body),
  updateClientComplaint: (id, body) => put(`/client-complaints/${id}`, body),
  professionals: () => get('/professionals'),
  syncProfessionals: () => post('/professionals/sync', {}),
